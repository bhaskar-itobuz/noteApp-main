        ...
        <>
            ...
            <div className="my-5">
                <div className="flex w-200 justify-center ">
                    <select className="note border-slate-200 rounded-md px-3 py-4 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" id="notes" onChange={handleChange} value={selectedOption} >
